...
<head>
    ...
    <link rel="stylesheet" href="{{asset ('fontawesome-free-5.8.2-web/css/all.min.css')}}">
    <link rel="stylesheet" href="{{asset ('css/app.css')}}">
    <link rel="stylesheet" href="{{asset ('css/temple1.css')}}">
...
<body>
    <nav id="nav_temple1" >
        <ul class="position_menu ">
            <div class="menu">
                <li class="nav_int"><a href="#">Início</a></li>
                <li class="nav_int"><a href="#">Entrar</a></li>
                <li class="nav_int"><a href="#">Novo cadastro</a></li>
...
<!--object_forme -->
<section class="form">
    <div class="bloc_1_form">1</div>    
    <div class="bloc_2_form">2
...
<div><form class="aaa">
    ...
    <div class="bloc_3_form"></div>
        
     
    <div class="bloc_4_form">4</div>    
</section>
